...
#! nix-shell -i bash -p "python3.withPackages (ps: [ ps.rich ])" wineWow64Packages.full winetricks dxvk zenity rsync gnutar zstd curl wget coreutils gnused gnugrep busybox
